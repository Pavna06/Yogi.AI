 ...
 * for the Yogi.AI application. By encapsulating the state and its update logic here,
...
// The core hook for managing the application's state.
export function useYogaApp() {
