/**
 * @fileoverview This is the main client component for the Yogi.AI application.
...
import { BreathingPane } from '@/features/dashboard/components/layout/BreathingPane';
