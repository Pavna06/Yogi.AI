...
// Define the props that will be passed down to the PoseCorrectionClient component.
// This ensures type safety between the loader and the actual component.
export type PoseCorrectionLoaderProps = {
...
/**
 * The loader component that wraps the dynamically imported PoseCorrectionClient.
 * It passes all its props directly to the client component once it's loaded.
 */
export function PoseCorrectionLoader(props: PoseCorrectionLoaderProps) {
  return <PoseCorrectionClient {...props} />;
}
